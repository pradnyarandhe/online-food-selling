<html>
  ...
  <head>
    <title> Feedback | Sanghamitra Caterer </title>
  </head>
...
?>
    ...
    <div class="container" >
      <div class="form-area">
      <div class="col-md-5" style="float: none; margin: 1 auto;">
        <form method="post" action="">
        <br style="clear: both">
          <h4 style="margin-bottom: 25px; text-align: center; font-size: 30px; color: white"> Feedback Form</h4>
...
$query = "INSERT into feedback(Name,Email,Mobile,Subject,Message) VALUES('$Name','$Email_Id','$Mobile_No','$Subject','$Message')";
