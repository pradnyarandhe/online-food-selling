...
<h2 class="text-center"  style="color:white;"> Thank you for Ordering at Sanghamitra Caterer! The ordering process is now complete.</h2>
<br>
<?php 
  $num1 = rand(100,9999); 
  $number = $num1;
...
<h3 class="text-center" style="color:white;"> <strong>Your Order Number:</strong> <span style="color: white;"><?php echo "$number"; ?></span> </h3>
