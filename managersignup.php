<html>
  ...
  <head>
    <title> Manager Signup | Sanghamitra Caterer </title>
  </head>
...
.header8{
  ...
  <body>
    ...
    <div class ="header8">
    <h3> Hey Manager, Welcome to <br> Sanghamitra Caterer!</h3>
    </div>
    <br>
    <br>
    ...
    <div class="container">
      ...
      <div class="col-md-5" style="float: none; margin: 0 auto;">
        <form method="post" action="manager_registered_success.php">
